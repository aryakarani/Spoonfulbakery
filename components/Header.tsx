...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-cream/80 backdrop-blur supports-[backdrop-filter]:bg-cream/70 border-b border-black/5">
      <div className="container-gutter h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {ig && (
            <a href={ig} target="_blank" rel="noreferrer" className="hidden lg:inline-flex btn btn-outline">
